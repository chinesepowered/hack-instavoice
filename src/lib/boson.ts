...
export async function createVoice(
  ...
  const out = await boson<{ voice?: string; id?: string }>("/v1/audio/voices", {
    method: "POST",
 ...
 * with base64 audio instead of raw bytes, and streaming is not allowed.
 */
